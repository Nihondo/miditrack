...
export declare function ym2608FrequencyToHz(fnum: number, block: number, clockRate: number, prescaler: number): number;
...
export declare function ym2608SSGRegisterToFrequency(register: number, clockRate: number, prescaler: number, flags: number): number;
