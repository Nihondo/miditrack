...
- Download the edited `.mid`, or the rendered `.wav` itself, with the buttons immediately below the standard audio player — a real deliverable, not just a preview. The uploaded/converted original is never modified
...
6. Click "MIDIをダウンロード" (Download MIDI) or "WAVをダウンロード" (Download WAV) immediately below the standard audio player to save the result
